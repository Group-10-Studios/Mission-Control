...
public class UiUtil {
     ...
     *
     * @param horizontalGap The horizontal gap to have inbetween columns. NOTE: This does not work if there is only
     *                     one column! Use the padding for that.
     * @param verticalGap   The vertical gap to have inbetween rows. NOTE: This does not work if there is only one
     *                     row! Use the padding for that.
    ...
    /**
     * Creates a VBox which height is equal to the sum of the children height + their gaps. The childrens
     * width will grow to always be the maximum size they can go (VBox width - padding).
     *
     ...
     * @param insets     The insets to set the child at.
     */
    public static void addNodeToGrid(Region child, GridPane parent, int row, int column, int rowSpan,
                                     int columnSpan, Insets insets) {
    ...
    public static void addPercentColumns(GridPane grid, double... percents) {
        // Constructor value v1 in Column/Row Constraints is pixel width/height,
        // so percents need to be a separate function call.
        // I know, it's lame.
    ...
    /**
     * Creates a HBox which width is equal to the sum of the children width + their gaps. The childrens
     * height will grow to always be the maximum size they can go (HBox height - padding).
     *
     * @param childrenGap The gap horizontal to put inbetween each child.
     * @param padding     The padding to set the HBox to have around the children.
     * @param children    The children to add to the HBox.
     * @return The final HBox.
     */
