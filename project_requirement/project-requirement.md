...
| Current member(s) leave the project/new member(s) joining the project | Possible | We will commit work regularly and keep clear documentation of progress, meeting minutes so that team member changes mean duties can be picked up smoothly, and that no work is lost. |
...
| Natural Disasters (earthquake, pandemic, tsunami, etc.) | Possible | Catastrophic | We have absolute no control over natural disasters. |
