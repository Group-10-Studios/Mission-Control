...
flight. If this requirement is not met it could lead to delayed response by the user which could result in harm to
...
Failure to prompt the user of these warning could result in an unsafe launch of the rocket leading to loss of hardware
